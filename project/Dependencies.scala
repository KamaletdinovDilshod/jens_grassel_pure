...
object Dependencies {
  ...
  object Versions {
    ...
    val refinedCore = "0.11.3"
    val refined = "0.11.3"
    val slick = "3.6.1"
    val slickHikari = "3.6.1"
  ...
  object Libraries {
    ...
    val flyway = "org.flywaydb" % "flyway-core" % "11.17.0"
    val flywayPostgres = "org.flywaydb" % "flyway-database-postgresql" % "11.17.0"
